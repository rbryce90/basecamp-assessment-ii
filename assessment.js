...
// CODE HERE
message['text'] = "Three magic number";
/**
 * #4
 *
...
// CODE HERE
var myFriends = ["Victoria", "Robbie", "Stephanie", "Katherine"];
/**
 * #6
 *
...
var indexFinder = indexes.forEach(function(val, i, arr){
  arr[i] = i;
});
